...
class Separate(Resource):
    ...
    async def render_GET_separate(self, request):
        time.sleep(5)
        return self
    ...
    async def render_POST_separate(self, request):
        self.payload = request.payload
        return self
    ...
    async def render_PUT_separate(self, request):
        self.payload = request.payload
        return self
    ...
    async def render_DELETE_separate(self, request):
        return True
...
class AdvancedResourceSeparate(Resource):
    ...
    async def render_GET_separate(self, request, response):
        time.sleep(5)
        response.payload = self.payload
        response.max_age = 20
        return self, response

    async def render_POST_separate(self, request, response):
        self.payload = request.payload
        response.payload = "Response changed through POST"
        return self, response

    async def render_PUT_separate(self, request, response):
        self.payload = request.payload
        response.payload = "Response changed through PUT"
        return self, response

    async def render_DELETE_separate(self, request, response):
        response.payload = "Response deleted"
        return True, response
