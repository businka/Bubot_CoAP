...
| No. | C | U | N | R | Имя | Формат | Длина | По умолчанию |
| -----| ---| ---| ---| ---| ----------------| --------| - -------| ---------- |
| 1 | х | | | х | If-Match | непрозрачный | 0-8 | (нет) |
| 3 | х | х | - | | Uri-Host | строка | 1-255 | (см. |
| | | | | | | | | ниже) |
| 4 | | | | х | ETag | непрозрачный | 1-8 | (нет) |
| 5 | х | | | | If-None-Match | пустой | 0 | (нет) |
| 7 | х | х | - | | Uri-Port | uint | 0-2 | (см. |
| | | | | | | | | ниже) |
| 8 | | | | х | Location-Path | строка | 0-255 | (нет) |
| 11 | х | х | - | х | Uri-Path | строка | 0-255 | (нет) |
| 12 | | | | | Content-Format | uint | 0-2 | (нет) |
| 14 | | х | - | | Max-Age | uint | 0-4 | 60 |
| 15 | х | х | - | х | Uri-Query | строка | 0-255 | (нет) |
| 17 | х | | | | Accept | uint | 0-2 | (нет) |
| 20 | | | | х | Location-Query | строка | 0-255 | (нет) |
| 35 | х | х | - | | Proxy-Uri | строка | 1-1034 | (нет) |
| 39 | х | х | - | | Proxy-Scheme | строка | 1-255 | (нет) |
| 60 | | | х | | Size1 | uint | 0-4 | (нет) |
...
| ID | Т, ТКЛ, код
| -| -| -| -| -| -| -| -| -| -| -| -| -| -| -| - |
 | QR | Код операции | AA | TC | RD | RA | Z | RCODE | ID сообщения
| -| -| -| -| -| -| -| -| -| -| -| -| -| -| -| - |
 | QDCOUNT | (варианты 0)
| -| -| -| -| -| -| -| -| -| -| -| -| -| -| -| - |
 | ANCOUNT | (варианты 0)
